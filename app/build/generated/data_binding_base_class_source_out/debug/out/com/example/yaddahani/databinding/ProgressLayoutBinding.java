...
public final class ProgressLayoutBinding implements ViewBinding {
  ...
  private ProgressLayoutBinding(@NonNull ConstraintLayout rootView,
      @NonNull ProgressBar myProgressBar) {
  ...
  public static ProgressLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProgressLayoutBinding((ConstraintLayout) rootView, myProgressBar);
    }
